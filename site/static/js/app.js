...
var chinese = {
    ...
    feature3body: "我们没有仅仅为了投机而创建新的加密货币，而是在我们不断发展的社交网络上提供代币来购买利润丰厚的，早期的，需求度高的广告。我们网络上的优质广告只接受TRU付款。",
    feature4header: "我们的用户想要TRU！",
    feature4body1: "True是一家有真实产品的真实公司，当前您正与硅谷最出色的投资者在同一平台上工作，我们用实实在在的解决方案改变着游戏，而不是垃圾标题党，也不是最劣等的个人数据挖掘。",
    feature4body2: "在本次预售之后，我们会给我们的全部用户提供TRU，需求和代币速度很可能会很高。",
    truevalueheader: "TRU的价值很容易理解—我们以巨大的折扣力度为早期投资者提供高级广告。",
    truevaluebody1: "加密投资者还能忍诈骗多久？",
    truevaluebody2: "TRU代币销售为您提供了一次获得高级代币的机会。我们提供给您的是基于普通投资者可以理解的成熟商业模式的实际资产的实际价值。 这就有点像拥有Facebook的早期股票一样。",
